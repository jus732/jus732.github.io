...
/*
 * About section content, split into three blocks so the classic /about page
 * can host each in its own window while the desktop About window renders
 * the combined AboutContent below.
 */

/** Bio paragraphs + the engineering-philosophy pull quote. */
...
/** Years-of-experience callout card. */
export function AboutExperience() {
  return (
    <Reveal delay={0.1}>
      <div className="surface-raised surface-interactive rounded-xl border border-border bg-card p-6">
...
/** Skill groups as wrapped chip rows. */
...
/**
 * Combined about layout for the desktop About window. Bio and philosophy on
 * the left, experience callout and skills on the right; collapses to a
 * single column on narrow surfaces.
 */
